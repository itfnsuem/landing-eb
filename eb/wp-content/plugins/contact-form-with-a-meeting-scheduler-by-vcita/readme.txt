...
Tags: contact form, contact form builder, HTML form, form  maker, custom form, contact form 7, feedback form, contact form DB, CRM, pop up, contact us, online form
...
A friendly contact form to make sure you never miss out on a new lead. Create & add in minutes, start capturing more opportunities on your site today.
== Description ==

Contact Form plugin for WordPress by vCita is the ultimate way to capture and manage leads on your WordPress website.<BR>
...
All contact form submissions will be sent to your email, as well as added to your **vCita MOBILE CRM** where you can manage all your contacts and leads more effectively, from your office or on-the-go.

>[vCita WordPress Plugins](http://www.vcita.com/wordpress-plugins?o=WP&invite=WP "vCita contact form for WordPress") | [Live Demo](http://c.betterwebsitetoday.com/contact/ "vCita") | [FAQ & Support](http://support.vcita.com/home "vCita support forum") | [For Web Professionals](https://www.vcita.com/partners/web-professionals?invite=WP&o=WP "partners")
...
* **Active Contact Form -  LiveSite Widget** – Helps you capture more leads on your website! The widget encourages more visitors and potential clients to take action and contact: send a message, schedule an appointment, upload documents or even pay for services, any time, using any device

Contact form plugin helps you create a "contact us" page with the vCita contact form widget in it, or add the contact form to any page using **Shortcode**

= vCita Mobile CRM to manage contact form submissions and new leads: = 
* Receive real time email and mobile notification for every form submission or contact request on your website
* Keep complete archive with every contact and client communication.
...
* Quickly view and reply on-the-go with the vCita Mobile App for <a href="https://itunes.apple.com/app/vcita-mobile-crm/id1025423769?mt=8">iPhone</a> or <a href="https://play.google.com/store/apps/details?id=com.vcita.mobileapp">Android</a>

= Translations = 
Contact Form Builder by vCita is fully translated to:
...
Contact Form Builder plugin connects to your vCita account. You may create a FREE account at vCita directly from the plugin.<BR>
Download Our WordPress Contact Form Now.<BR>

http://www.youtube.com/watch?v=zFCzJJew63o

**vCita Contact Form Plugin can be used free forever, and also offers several premium options** 
...
* Notifications on any contact form submission to your email and Phone
* Integrated CRM solution

<BR>
= Premium Contact Form advanced options: = 
* Manage clients across you team - assign leads and contact form submissions to different staff members
...
2. **Proactive Contact Form** - Don't wait for visitors to contact you, approach them on any page and double your leads!
3. **Customize colors and fonts** - Customize your contact form's colors, border styles, fonts and sizes.
4. **Multiple Layout Options to choose from** - Create the contact form that best fits your website. Your contact form can include different info and actions.
5. **Custom Fields** - Add, Edit and Remove fields with a simple drag and drop UI.
6. **Customize colors and fonts** - Customize your contact form's colors, border styles, fonts and sizes. 
7. **View full correspondence** -  View all client requests in one place, where you can also take action - reply, schedule a follow-up meeting and send an invoice.
8. **Track and Manage contacts** - Keep history of contacts, manage contact details and track whether your messages are read by clients. 
 ...
 * New screenshots
 ...
 == Upgrade Notice == 
Now compatible with WordPress 4.9! New features: set date-specific availability, schedule recurring appointments, create & share discount coupons, improved invoicing & payment management